...
module.exports = {
      ...
      ***************************************************************************/
      default: {
        ...
        ****************************************************************************/
        // ssl: true,
        adapter: 'sails-mongo',
        url: 'mongodb://XX.XXX.2.4:27017/xxxxxstaging',
      },
    ...
    ***************************************************************************/
    session: {
      ...
      ***************************************************************************/
      ...
      //
      //--------------------------------------------------------------------------
      secret: 'd210587bc01847ffe386075b63c29d76',
      adapter: 'connect-mongo',
      // Note: user, pass and port are optional
      url: 'mongodb://XX.XXX.2.4:27017/xxxxxxxxxstaging',
      collection: 'sessions',
    ...
    ***************************************************************************/
    custom: {
      ...
      //--------------------------------------------------------------------------
      oktaConfig: {
        issuer: "http://www.okta.com/dsfsdfsdfsdfsfsfahyukkfd",
        entryPoint: "https://xxxxxxx.oktapreview.com/app/xxxxxxxxpreview_xxxxxsaml_1/sfdsfsdfsdfsdfsdf/sso/saml",
        callbackUrl: "https://stg-xxxxxxxx.xxxxxxxx.com/api/authorization-code/callback",
        cert: "dfsdfsdfdsfdsffdsf3423dfdvxvdfhfh42434543sdfsdf4345345sfsdfdsfwsfsfdsfdsfsdfdsfdsfdsfdsfdsfdsf",
        uiCallback: "https://stg-xxxxxx.xxxxxxxx.com/authorization-code/callback"
      },

      mailConfig: {
        host: 'XX.XXX.1.5',
        port: 25,
        requestAccessMailAddress: 'APP-OKTA-xxxxx-Admin@xxxxxx.com',
        mailBcc: 'xxxxxxxx.t@xxxxxxxx.com',
        mailSubject: '[xxxxxxxx Staging] Requesting xxxxx access',
        fromAddress: 'noreply-xxxxxx@xxxxxxxxx.com'
      },
    },
