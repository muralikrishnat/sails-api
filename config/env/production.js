...
module.exports = {
    ...
    ***************************************************************************/
    default: {
      ...
      ****************************************************************************/
      // ssl: true,
      adapter: 'sails-mongo',
      url: 'mongodb://XX.XXX.1.8:27017,XX.XXX.1.9:27017,XX.XXX.1.10:27017/app?replicaSet=prodreplica&readPreference=nearest&slaveOk=true',
    },
  ...
  ***************************************************************************/
  session: {
    ...
    ***************************************************************************/
    ...
    url: 'mongodb://XX.XXX.1.8:27017/appdb',
    collection: 'sessions',
  ...
  ***************************************************************************/
  custom: {
    ...
    oktaConfig: {
      issuer: "http://www.okta.com/fdgdfgdfgdfgfdg",
      entryPoint: "https://xxxxxxx.okta.com/app/xxxxxx_xxxx_1/exk8wofx95amCpLPp1t7/sso/saml",
      callbackUrl: "https://xxxxxxxx.xxxxxxxx.com/api/authorization-code/callback",
      cert: "dfdsfsdf3dsfdsfdsfdsxxxxdddssfdsfdsfsfsfsfsff",
      uiCallback: "https://xxxxxx.xxxxxx.com/authorization-code/callback"
    },

    mailConfig: {
      host: 'XX.XXX.1.5',
      port: 25,
      requestAccessMailAddress: 'APP-OKTA-xxx-Admin@xxxxx.com',
      mailBcc: '',
      mailSubject: 'Requesting xxxxx access',
      fromAddress: 'noreply-xxxxx@xxxxxxx.com'
    },
  },
