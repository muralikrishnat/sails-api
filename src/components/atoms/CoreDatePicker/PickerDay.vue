<template>
  ...
  >
    ...
    <header>
      ...
      >
        <object type="image/svg+xml" data="/img/icons/arrow-fill-right.svg" class="icon rotate-180"></object>
      </span>
      <span
      ...
      >
        <object type="image/svg+xml" data="/img/icons/arrow-fill-right.svg" class="icon"></object>
      </span>
    </header>
    ...
    <div class="vdp-datepicker__footer">
      <ActionButton buttonStyle="primary full-width">
        <template slot="button-text-slot"> Jump To Current Week </template>
      </ActionButton>
    </div>
  </div>
</template>
