...
module.exports = {
      ...
      ***************************************************************************/
      default: {
        ...
        ****************************************************************************/
        // ssl: true,
        adapter: 'sails-mongo',
        url: 'mongodb://XX.XXX.X.XX:27017/appdev',
      },
    ...
    security: {
      ...
      ***************************************************************************/
      cors: {
        allowOrigins: [
          'http://localhost:8080',
          'https://stg-app.xxxxx.com',
          'http://stg-app.xxxxxx.com'
        ]
      },
    ...
    ***************************************************************************/
    custom: {
      ...
      //--------------------------------------------------------------------------
      oktaConfig: {
        issuer: "http://www.okta.com/ddsfsdf34csxrgsdfsff",
        entryPoint: "https://dev-34234.oktapreview.com/app/fgdfgfdg34535345_xxxxxxxxsaml_1/dsfdsfsdfsdfsdfsdfsdf/sso/saml",
        callbackUrl: "https://dev-dsfsdf.domain.com/api/authorization-code/callback",
        cert: "gfgfdgdfgfdg23dfdf32dsfsdf3dfdsf3dfsdf3ddsf3ffs3ffsff",
        uiCallback: "https://dev-app.domain.com/authorization-code/callback"
      },

      mailConfig: {
        host: '10.116.1.5',
        port: 25,
        requestAccessMailAddress: 'xxxxx.t@xxxxxxx.com',
        mailBcc: 'xxxxxxxx.t@xxxxxxx.com',
        mailSubject: '[XXXXX Development] Requesting XXXX access',
        fromAddress: 'xxxxxxx.x@xxxxxxxx.com'
      },
    },
